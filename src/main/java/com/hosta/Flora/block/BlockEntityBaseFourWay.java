...
public abstract class BlockEntityBaseFourWay extends BlockBaseFourWay implements ITileEntitySupplier {

	private final Supplier<TileEntity> SUPPLIER;

	public BlockEntityBaseFourWay(Block.Properties property, Supplier<TileEntity> supplier)
	{
		super(property);
